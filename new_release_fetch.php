...
$sql = "SELECT m.movie_id, m.movie_name, m.movie_year, m.movie_language, m.plot, m.genre, m.prating, m.director_id, m.actor_id, a.actor_name, d.director_name FROM movie m,actor a,director d where m.actor_id=a.actor_id and m.director_id=d.director_id and m.movie_year>2018 order by m.movie_year desc";
    ...
    if(mysqli_num_rows($result) > 0){
        ...
        while($row = mysqli_fetch_array($result)){
            echo "<tr>";
				...
				$x++;
                echo "<td><a href=moviedetail.php?varname=$movie_id[$y]>" . $row['movie_name'] . "</a></td>";
				$y++;
