...
<html>
	...
	<div class="content">
      ...
      <div class="wrapper style2" style="background: #333333 url(Images/background.png)";>
                ...
                <section class="4u">
                  <a href="" class="image feature"><img src="images/sarileru neekevvaru.jpg" alt=""></a>
...
$sql = "SELECT m.movie_id, m.movie_name, m.movie_year, m.movie_language, m.plot, m.genre, m.prating, m.director_id, m.actor_id, a.actor_name, d.director_name FROM movie m,actor a,director d where m.actor_id=a.actor_id and m.director_id=d.director_id and m.movie_id=204";
